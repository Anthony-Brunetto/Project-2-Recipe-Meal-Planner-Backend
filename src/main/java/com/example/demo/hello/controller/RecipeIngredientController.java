...
import com.example.demo.hello.exception.RecipeIngredientNotFoundException;
...
import com.example.demo.hello.repository.RecipeIngredientRepository;
...
public class RecipeIngredientController {
    ...
    public ResponseEntity<RecipeIngredient> createRecipeIngredient(
        ...
        RecipeIngredient saved = recipeIngredientRepository.save(newRecipeIngredient);

        return ResponseEntity
            .created(
                URI.create(
                    "/api/recipe-ingredients/" +
                    saved.getRecipeIngredientId()
                )
            )
            .body(saved);
    }
    ...
    private com.example.demo.hello.entity.Recipe getRecipe(
    ...
    private com.example.demo.hello.entity.Ingredient getIngredient(
        RecipeIngredient recipeIngredient
    ) {
        if (
