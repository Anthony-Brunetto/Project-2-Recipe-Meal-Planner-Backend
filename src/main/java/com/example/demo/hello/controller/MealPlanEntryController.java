...
import com.example.demo.hello.exception.MealPlanEntryNotFoundException;
import com.example.demo.hello.repository.MealPlanEntryRepository;
...
public class MealPlanEntryController {
    ...
    public MealPlanEntryController(MealPlanEntryRepository mealPlanEntryRepository) {
    ...
    MealPlanEntry newMealPlanEntry(@RequestBody MealPlanEntry newMealPlanEntry) {
